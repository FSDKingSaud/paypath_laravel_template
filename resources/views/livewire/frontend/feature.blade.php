@section('hero-about-section')
    <!-- ======== 3.1. hero section ========  -->
    <section class="feature-hero aos-init aos-animate" data-aos="zoom-in">
        <div class="container">
    ...
    <section class="core">
        <div class="container">
            ...
            <div class="row d-flex gap-md-0 gap-sm-5 gap-5">
                <div class="col-lg-4 col-md-4 d-flex flex-column gap-3 justify-content-center aos-init" data-aos="fade-up">
                    <div class="core-card">
                ...
                <div class="col-lg-4 col-md-4 d-flex justify-content-center align-items-center aos-init" data-aos="zoom-in">
                    <figure><img src="assets/images/feauter/mobile.png" alt="img" class="moving"></figure>
                </div>
                <div class="col-lg-4 col-md-4 d-flex flex-column gap-3 justify-content-center aos-init"
                    data-aos="fade-down">
                        ...
                        <div class="visa-logo pt-2 pb-3 slick-initialized slick-slider">
                            <div class="slick-list draggable">
                                <div class="slick-track"
                                    style="opacity: 1; width: 1596px; transform: translate3d(-1026px, 0px, 0px); transition: transform 3000ms linear;">
