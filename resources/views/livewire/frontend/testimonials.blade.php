@section('hero-about-section')
    ...
    <div class="container">
        <div class="testimon-hero">
            <h2>TESTIMONIALS</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto eligendi in provident nam
                impedit corporis?</p>
        </div>
    </div>
    ...
    <section class="profaessional mb-lg-4 mb-md-2 mb-sm-1 mb-1">
        <div class="container">
            <div class="prof-size d-flex flex-column gap-5">
                <div class="prof-slid position-relative aos-init aos-animate" data-aos="zoom-in-up">
                    <div>
                        <div class="d-flex  align-items-center justify-content-center">
                            <img src="assets/images/slider/profational2.png" alt="img" class="prof-img-2">
                        </div>
                        <div class="pe-3">
                ...
                <div class="prof-slid position-relative aos-init" data-aos="zoom-in-up">
                    <div>
                        <div class="d-flex  align-items-center justify-content-center">
                            <img src="assets/images/slider/profactional3.png" alt="img" class="prof-img-2">
                        </div>
                        <div class="pe-3">
                            <img src="assets/images/slider/Comma.png" alt="img" class="prof-img-1">
                        </div>
                ...
                <div class="prof-slid position-relative aos-init" data-aos="zoom-in-up">
                    <div>
                        <div class="d-flex  align-items-center justify-content-center">
                            <img src="assets/images/slider/profacitional.png" alt="img" class="prof-img-2">
                        </div>
                        <div class="pe-3">
                            <img src="assets/images/slider/Comma.png" alt="img" class="prof-img-1">
                        </div>
