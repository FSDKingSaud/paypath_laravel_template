        ...
        <div class="container">
            <div class="row text-md-start text-sm-center text-center gap-md-0 gap-sm-4 gap-5">
                <div data-aos="fade-up"
                    class="col-md-6 d-flex align-items-md-start align-items-ms-center align-items-center justify-content-center flex-column aos-init aos-animate">
                    <h1>EMPOWER YOUR FINANCES</h1>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                        Ipsum has
                        been the industry's standard dummy text ever since the 1500s.</p>
                    <a class="btn-hover1" href="{{  route('about') }}">Get the Card</a>
                </div>
                <div data-aos="fade-down"
                    class="col-md-6 position-relative d-flex flex-column justify-content-center align-items-center mt-md-0 mt-sm-5 mt-4 aos-init aos-animate">
        ...
        <div class="container">
            <div class="row text-md-start text-sm-center text-center">
                <div class="col-md-6 d-flex justify-content-between">
                    <div class="ab_card1 aos-init" data-aos="flip-left">
                        <h3>About</h3>
                ...
                <div class="col-md-6 d-flex justify-content-center mt-md-0 mt-sm-3 mt-3">
                    <div class="ab_card2 d-flex flex-column justify-content-between aos-init" data-aos="flip-right">
                        <div>
                            <div class="row gap-md-0 gap-sm-3 gap-3">
                                ...
                                <div class="col-md-5 col-sm-12 col-12 p-0">
                                    <h3>0%</h3>
                                    <p class="p-f-s">Zero percent fee to any transaction Zero percent fee to any
                                        transaction
                                    </p>
                                </div>
                            </div>
...
@section('main-section')
        ...
        <div class="container text-center">
            ...
            <div class="finanes-card row gap-md-0 gap-sm-4 gap-4">
                <div class="col-lg-4 col-md-4 d-flex justify-content-center pe-lg-3 pe-md-0 pe-sm-3 pe-3">
                    <div class="fin-card aos-init" data-aos="flip-up">
                ...
                <div class="col-lg-4 col-md-4 d-flex justify-content-center pe-lg-3 pe-md-0 pe-sm-3 pe-3">
                    <div class="fin-card aos-init" data-aos="flip-up">
                        ...
                        <h4>Easy Payment</h4>
                        <p class="p-f-s">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore itaque
                            nam
                            pariatur.
                        </p>
                    </div>
    ...
    <div class="ispsum-logo">
        <div class="container">
            <hr>
            <div class="logo_ispsum_slider slick-initialized slick-slider">
                <div class="slick-list draggable">
                    <div class="slick-track"
                        style="opacity: 1; width: 6480px; transform: translate3d(-1944px, 0px, 0px); transition: transform 3000ms linear;">
                        <div class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1"
                            style="width: 324px;">
                            <div><a href="#" style="width: 100%; display: inline-block;" tabindex="-1">
                        ...
                        <div class="slick-slide" data-slick-index="1" aria-hidden="true" style="width: 324px;">
                            <div><a href="#" style="width: 100%; display: inline-block;" tabindex="0">
                                    <figure><img src="assets/images/icon/ipsum-2.png" alt="img"></figure>
                                </a></div>
                        </div>
                        ...
                        <div class="slick-slide slick-active" data-slick-index="5" aria-hidden="false" tabindex="-1"
                            style="width: 324px;">
                            <div><a href="#" style="width: 100%; display: inline-block;" tabindex="-1">
                                    <figure><img src="assets/images/icon/ipsum-2.png" alt="img"></figure>
                                </a></div>
    ...
    <section class="gateway">
        <div class="container">
            <div class="row gap-lg-0 gap-md-0 gap-sm-4 gap-4">
                <div class="col-lg-6 col-md-6 d-flex align-items-center justify-content-center aos-init"
                    data-aos="fade-up">
                    <div class=" gateway-bg-img mt-5 ">
                        <figure><img src="assets/images/index/gateway-1.png" alt="gate_img1" class="moving">
                        </figure>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 text-md-start text-sm-center text-center aos-init" data-aos="fade-down">
                    ...
                    <div class="gate-link text-lg-start text-md-start text-sm-center text-center">
                        <a class="btn-hover1" href="{{  route('about') }}">Get Started</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="services">
        <div class="container">
            <div class="row gap-md-0 gap-sm-4 gap-4">
                <div class="col-lg-6 col-md-6 aos-init" data-aos="fade-down">
                ...
                <div class="col-lg-6 col-md-6 d-flex align-items-center justify-content-center sevices_img aos-init"
                    data-aos="fade-up">
                    <div class="position-relative">
    ...
    <section class="visa">
        <div class="container">
            <div class="visa-bg aos-init" data-aos="zoom-in">
                <figure><img src="assets/images/index/vesa-back.png" alt="visa-img"></figure>
            </div>
            <div class="visa-contant aos-init" data-aos="fade-up">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="visa-logo pt-2 pb-3 slick-initialized slick-slider">
                            <div class="slick-list draggable">
                                <div class="slick-track"
                                    style="opacity: 1; width: 1596px; transform: translate3d(-798px, 0px, 0px); transition: transform 3000ms linear;">
                                    <div class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true"
                                        tabindex="-1" style="width: 114px;">
                                        <div>
                                            <figure style="width: 100%; display: inline-block;"><img
                                                    src="assets/images/icon/ves-2.png" alt="vica-icon2"></figure>
                                        </div>
                                    </div>
                                    <div class="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true"
                                        ...
                                        <div>
                                            <figure style="width: 100%; display: inline-block;"><img
                                                    src="assets/images/icon/ves-3.png" alt="vica-icon3"></figure>
                                        </div>
                                    </div>
                                    <div class="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true"
                                        ...
                                        <div>
                                            <figure style="width: 100%; display: inline-block;"><img
                                                    src="assets/images/icon/ves-4.png" alt="vica-icon4"></figure>
                                        </div>
                                    </div>
                                    <div class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true"
                                        ...
                                        <div>
                                            <figure style="width: 100%; display: inline-block;"><img
                                                    src="assets/images/icon/ves-5.png" alt="vica-icon5"></figure>
                                        </div>
                                    </div>
                                    <div class="slick-slide" data-slick-index="0" aria-hidden="true" tabindex="-1"
                                        style="width: 114px;">
                                        <div>
                                            <figure style="width: 100%; display: inline-block;"><img
                                                    src="assets/images/icon/vis-1.png" alt="vica-icon1"> </figure>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slick-slide slick-current slick-active" data-slick-index="3"
                                        aria-hidden="false" style="width: 114px;">
                                        <div>
                                            <figure style="width: 100%; display: inline-block;"><img
                                                    src="assets/images/icon/ves-4.png" alt="vica-icon4"></figure>
                                        </div>
                                    ...
                                    <div class="slick-slide slick-cloned slick-active" data-slick-index="5"
                                        aria-hidden="false" tabindex="-1" style="width: 114px;">
                                        <div>
                                            <figure style="width: 100%; display: inline-block;"><img
                                                    src="assets/images/icon/vis-1.png" alt="vica-icon1"> </figure>
                                        </div>
    ...
    <section class="pricing pricing-b-g">
        <div class="container">
            <div class="row ">
                <div class="col-lg-6 col-md-6 d-flex align-items-center justify-content-center pricing-bg aos-init"
                    data-aos="fade-up">
                    <div>
                        <figure><img src="assets/images/index/pricinge.png" alt="pric-img1" class="moving">
                        </figure>
                        <figure><img src="assets/images/icon/hero_star.png" alt="pric-img2"></figure>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 mt-md-0 mt-sm-5 mt-5 aos-init" data-aos="fade-down">
    ...
    <section class="profaessional">
        <div class="container">
            ...
            <div class="prof-size aos-init" data-aos="zoom-in-up">
                <div class="prof-slider  slick-initialized slick-slider"><button class="slick-prev slick-arrow"
                        aria-label="Previous" type="button" style="display: block;">Previous</button>
                    <div class="slick-list draggable">
                        <div class="slick-track"
                            style="opacity: 1; width: 6349px; transform: translate3d(-1814px, 0px, 0px);">
                            <div class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true"
                                tabindex="-1" style="width: 907px;">
                                <div>
                                    <div class="prof-slide position-relative" style="width: 100%; display: inline-block;">
                                        <div>
                                            <div class="d-flex  align-items-center justify-content-center">
                                                <img src="assets/images/slider/profacitional.png" alt="img"
                                                    class="prof-img-2">
                                            </div>
                                            <div>
                                                <img src="assets/images/slider/Comma.png" alt="img"
                                                    class="prof-img-1">
                                            </div>
                                            <p class="text-center p-f-s">Lorem ipsum dolor, sit amet consectetur
                                                adipisicing elit.
                                                Enim
                                                qui
                                                porro perferendis voluptatibus minima, eius illo animi nihil sed
                                                natus! Deleniti
                                                officia
                            ...
                            <div class="slick-slide" data-slick-index="0" aria-hidden="true" tabindex="-1"
                                ...
                                <div>
                                    <div class="prof-slide position-relative" style="width: 100%; display: inline-block;">
                                        <div>
                                            <div class="d-flex  align-items-center justify-content-center">
                                                <img src="assets/images/slider/profational2.png" alt="img"
                                                    class="prof-img-2">
                                            </div>
                                            <div>
                                                <img src="assets/images/slider/Comma.png" alt="img"
                            ...
                            <div class="slick-slide slick-current slick-active" data-slick-index="1" aria-hidden="false"
                                ...
                                <div>
                                    <div class="prof-slide position-relative" style="width: 100%; display: inline-block;">
                                        <div>
                                            <div class="d-flex  align-items-center justify-content-center">
                                                <img src="assets/images/slider/profactional3.png" alt="img"
                                                    class="prof-img-2">
                                            </div>
                                            <div>
                                                <img src="assets/images/slider/Comma.png" alt="img"
    ...
    <section class="question">
        <div class="container">
            <div class="row">
                <div class="question-text col-lg-6 col-md-6 tab-center aos-init" data-aos="fade-up">
                    ...
                    <div class="text-lg-start text-md-start text-sm-center text-center ">
                        <a class="btn-hover1" href="{{  route('faq') }}">More FAQs</a>
                    </div>
                </div>
                <div class="question-collapes col-lg-6 col-md-6 mt-md-0 mt-sm-3 mt-3 aos-init" data-aos="zoom-in">
    ...
    <section class="news-cards">
        <div class="container">
            ...
            <div class="row d-flex gap-md-0 gap-sm-5 gap-4">
                <div class="col-lg-4 col-md-4 d-flex aos-init" data-aos="flip-right">
